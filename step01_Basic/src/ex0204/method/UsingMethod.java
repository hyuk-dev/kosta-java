...
class UsingMethodExam{
	...
	*/	
	...
	public String methodExam03_02(String s, int num) {
	...
	*/	
	...
	void methodExam03_03(int num, String s) {
		System.out.println("methodExam03_03이 호출되었습니다.");
		this.methodExam03_02(s, num);
	}
	...
	*/	
	...
	protected float methodExam03_04(int num1, double decimal, int num2) {
		System.out.println("methodExam03_04가 호출되었습니다.");
		MakeMethodExam02 mme02 = new MakeMethodExam02();
		float f = mme02.methodExam02_04(num1, decimal, num2);
		return f;
	}
...
public class UsingMethod{
	//메인메소드에서
		...
		public static void main(String[] args) {
			...
			ume.methodExam03_02("동혁", 5);
			ume.methodExam03_03(3, "혁");
			ume.methodExam03_04(2, 4, 8);
		}
