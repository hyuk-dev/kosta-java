...
/*	
	...
	(구현부에서)하는일 : 첫번째 인수 곱하기 두번째인수 빼기 세번째인수 결과 출력
			     위의 결과를 리턴
*/
	protected float methodExam02_04(int num1, double decimal, int num2) {
		System.out.println(num1 * decimal - num2);
		return (float)(num1 * decimal - num2);
	}
